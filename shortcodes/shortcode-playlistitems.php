...
*/
function cws_ytp_shortcode_playlistitems( $atts ) {
    ...
    // wp_enqueue_script( 'cws_ytp_init', plugin_dir_url( __FILE__ )  . 'js/init-playlistitems.js', array(), false, true );


    // Load dependencies...
    // Initialize any scripts?
    wp_register_script( 'cws_ytp_init', plugin_dir_url( __FILE__ )  . 'js/init-playlistitems.js' );
    ...
    if( $plugin->get_isPro() == 1 ){
        ...
        wp_localize_script( 'cws_ytp_init_slick', 'php_vars_slick', $dataToBePassedtoSlick ); // ERROR 403 - when have 'php_vars'
...
//die();
    ...
    wp_enqueue_script( 'cws_ytp_init', plugin_dir_url( __FILE__ )  . 'js/init-playlistitemsxxx.js', array(), false, 0 );
    ...
    $strOutput = '<div class="cws-ytp"><div id="cws-ytp-header"></div>
        ...
        <div class="cws-ytp-button-container">
            ...
            <!-- <div id="view-layout">
                <a href="#" title="Carousel View" id="carousel-button" class="paging-button">Carousel</i></a>
