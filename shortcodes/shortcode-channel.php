...
*/
function cws_ytp_shortcode_channel( $atts ) {
    ...
    $api_key        = $cws_ytp_code['api_key']; // TODO: IF NO API KEY EXIT OUT A HERE!!!!!!!!

    if(empty($api_key)){
        $strOutput = 'API KEY MISSING, CHECK SETTINGS';
        return $strOutput;
    }
    ...
    // pull in js to init cws object...
    if( $plugin->get_isPro() == 1 ){
        wp_register_script( 'cws_ytp_init', plugin_dir_url( __FILE__ )  . 'pro/js/init-channel.js' );
    } else {
        wp_register_script( 'cws_ytp_init', plugin_dir_url( __FILE__ )  . 'js/init-channel.js' );        
    }
    ...
    if( $plugin->get_isPro() == 1 ){
        // wp_enqueue_script( 'cws_ytp_slick', plugin_dir_url( __FILE__ )  . '../public/js/slick/slick.js', array( 'jquery','my_app' ), false, true  );
        wp_enqueue_script( 'cws_ytp_slick', plugin_dir_url( __FILE__ )  . '/pro/lib/slick/slick.js', array( 'jquery','my_app' ), false, true  );

        //cws_youtube_pro/public/js/slick
        //cws_youtube_pro/shortcodes/pro/lib/slick
        ...
        $dataToBePassedtoSlick = array (
                                        ...
                                        'inner' => array(
                                                            ...
                                                            // not overidable via shortcode
                                                            'duration'              => (bool) $duration,
                                                            'playIcon'              => (bool) $playIcon,
                                                            'title'                 => (bool) $title,
                                                            ...
                                                            // not overidable via shortcode
                                                            'duration_adv1'              => (bool) $duration_adv1,
                                                            'playIcon_adv1'              => (bool) $playIcon_adv1,
                                                            'title_adv1'                 => (bool) $title_adv1,
                                                            ...
                                                            // not overidable via shortcode
                                                            'duration_adv2'              => (bool) $duration_adv2,
                                                            'playIcon_adv2'              => (bool) $playIcon_adv2,
                                                            'title_adv2'                 => (bool) $title_adv2,
                                                            ...
                                                            // not overidable via shortcode
                                                            'duration_adv3'              => (bool) $duration_adv3,
                                                            'playIcon_adv3'              => (bool) $playIcon_adv3,
                                                            'title_adv3'                 => (bool) $title_adv3,
                                                        ),
                                        ); 
        // Debug display array
        if(  isset($_GET['cws_debug'])  == "1" ) { 
        ...
        // Initialize Slick        
        // wp_register_script( 'cws_ytp_init_slick', plugin_dir_url( __FILE__ )  . '../public/js/slick/init_slick.js' );
        ...
        wp_enqueue_script( 'cws_ytp_init_slick', array( 'cws_ytp_slick' ), false , true ); // Initialize Slick WITH options!  
    }

    // Data to be passed to init-channel.js
...
//die();
    ...
    wp_enqueue_script( 'cws_ytp_init', plugin_dir_url( __FILE__ )  . 'js/init-channel.js', array( 'my_app' ), false, 0 );

    $strOutput = '<div class="cws-ytp"><div id="cws-ytp-header"></div>
        ...
        <!-- 1. The <iframe> (and video player) will replace this <div> tag. -->
            ...
            <a href="#" id="cws-ytp-video-stop-button">×</a>
                ...
                <div id="cws-ytp-video-container">
                    ...
                    <div id="cws-ytp-video-controls">
                        ...
                        <a href="#" id="cws-ytp-video-prev-button" class="cws-ytp-next-previous-video">
                            <i class="fa fa-angle-left"></i>
                        </a>
                        <a href="#" id="cws-ytp-video-next-button" class="cws-ytp-next-previous-video">
        ...
        <div class="cws-ytp-button-container">
            <div id="cws-ytp-pagination">
                <a href="#" title="Previous page of videos" id="cws-ytp-prev-button"><i class="fa fa-chevron-left"></i></a>
                <a href="#" title="Next page of videos" id="cws-ytp-next-button"><i class="fa fa-chevron-right"></i></a>
            </div>
        </div>

        <div id="cws_ytp"></div></div>';
